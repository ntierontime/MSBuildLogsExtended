...
namespace MSBuildLogsExtended.EntityFrameworkDAL
{
    ...
    /// 3. Queries
    /// </summary>
    public class EFDataAccessLayerEntityBuildEventCode
        : MSBuildLogsExtended.DALContracts.DataAccessLayerEntityContractBuildEventCode//<MSBuildLogsExtended.DataSourceEntities.BuildEventCodeCollection, MSBuildLogsExtended.DataSourceEntities.BuildEventCode, MSBuildLogsExtended.DataSourceEntities.BuildEventCodeIdentifier>
    {
        ...
        /// for log4net
        /// </summary>
        private static readonly log4net.ILog log = log4net.LogManager.GetLogger(typeof(EFDataAccessLayerEntityBuildEventCode));
        ...
        /// </summary>
        public EFDataAccessLayerEntityBuildEventCode()
        {
        }
        ...
        public EFDataAccessLayerEntityBuildEventCode(MSBuildLogsExtended.EntityFrameworkContext.MSBuildLogsExtendedEntities linqContext)
        {
    ...
    //                }
        ...
        private MSBuildLogsExtended.EntityFrameworkContext.BuildEventCode GetLinqObjectByIdentifier(MSBuildLogsExtended.EntityContracts.IBuildEventCodeIdentifier id)
        {
            ...
            return this.LinqContext.BuildEventCode.SingleOrDefault<MSBuildLogsExtended.EntityFrameworkContext.BuildEventCode>(m_Predicate);
        }
