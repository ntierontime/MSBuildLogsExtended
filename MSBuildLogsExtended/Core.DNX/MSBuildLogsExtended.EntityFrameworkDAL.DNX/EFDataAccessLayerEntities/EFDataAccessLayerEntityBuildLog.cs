...
namespace MSBuildLogsExtended.EntityFrameworkDAL
{
    ...
    /// 3. Queries
    /// </summary>
    public class EFDataAccessLayerEntityBuildLog
        : MSBuildLogsExtended.DALContracts.DataAccessLayerEntityContractBuildLog//<MSBuildLogsExtended.DataSourceEntities.BuildLogCollection, MSBuildLogsExtended.DataSourceEntities.BuildLog, MSBuildLogsExtended.DataSourceEntities.BuildLogIdentifier>
    {
        ...
        /// for log4net
        /// </summary>
        private static readonly log4net.ILog log = log4net.LogManager.GetLogger(typeof(EFDataAccessLayerEntityBuildLog));
        ...
        /// </summary>
        public EFDataAccessLayerEntityBuildLog()
        {
        }
