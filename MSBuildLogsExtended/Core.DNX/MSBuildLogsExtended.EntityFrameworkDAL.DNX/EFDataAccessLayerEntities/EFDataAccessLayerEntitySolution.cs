...
namespace MSBuildLogsExtended.EntityFrameworkDAL
{
    ...
    /// 3. Queries
    /// </summary>
    public class EFDataAccessLayerEntitySolution
        : MSBuildLogsExtended.DALContracts.DataAccessLayerEntityContractSolution//<MSBuildLogsExtended.DataSourceEntities.SolutionCollection, MSBuildLogsExtended.DataSourceEntities.Solution, MSBuildLogsExtended.DataSourceEntities.SolutionIdentifier>
    {
        ...
        /// for log4net
        /// </summary>
        private static readonly log4net.ILog log = log4net.LogManager.GetLogger(typeof(EFDataAccessLayerEntitySolution));
        ...
        /// </summary>
        public EFDataAccessLayerEntitySolution()
        {
        }
        ...
        public EFDataAccessLayerEntitySolution(MSBuildLogsExtended.EntityFrameworkContext.MSBuildLogsExtendedEntities linqContext)
        {
        ...
        public MSBuildLogsExtended.DataSourceEntities.DataAccessLayerMessageOfEntityCollectionSolution Insert(MSBuildLogsExtended.DataSourceEntities.Solution input)
        {
            ...
            if (input != null)
            {
                ...
                this.LinqContext.Solution.Add(_LinqItem);
        ...
        public MSBuildLogsExtended.DataSourceEntities.DataAccessLayerMessageOfEntityCollectionSolution Delete(MSBuildLogsExtended.DataSourceEntities.Solution input)
        {
            ...
            if (input != null)
            {
                ...
                if (_LinqItem != null)
                {
                    this.LinqContext.Solution.Remove(_LinqItem);
                    this.LinqContext.SaveChanges();
                }
            }
    ...
    //                }
        ...
        private MSBuildLogsExtended.EntityFrameworkContext.Solution GetLinqObjectByIdentifier(MSBuildLogsExtended.EntityContracts.ISolutionIdentifier id)
        {
            ...
            return this.LinqContext.Solution.SingleOrDefault<MSBuildLogsExtended.EntityFrameworkContext.Solution>(m_Predicate);
        }
