...
namespace MSBuildLogsExtended.DALContracts
{
    ...
    public interface DataAccessLayerEntityContractBuild<TCollection, T, TIdentifier, TCollectionMessage>
    ...
    /// There is a DataAccessLayerEntityContract class for each entity, which inherits from <see cref="Framework.DAL.DataAccessLayerContractBase&lt;TCollection, T, TIdentifier&gt;"/> with 3 type arguments, entity class and its collection class, and identifier class.
    /// </summary>
    public interface DataAccessLayerEntityContractBuild: DataAccessLayerEntityContractBuild<MSBuildLogsExtended.DataSourceEntities.BuildCollection, MSBuildLogsExtended.DataSourceEntities.Build, MSBuildLogsExtended.DataSourceEntities.BuildIdentifier, MSBuildLogsExtended.DataSourceEntities.DataAccessLayerMessageOfEntityCollectionBuild>
    {
