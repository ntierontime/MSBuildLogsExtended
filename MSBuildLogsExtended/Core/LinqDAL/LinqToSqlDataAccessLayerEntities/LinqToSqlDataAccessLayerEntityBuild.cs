...
namespace MSBuildLogsExtended.LinqDAL
{
    ...
    /// 3. Queries
    /// </summary>
    public class LinqToSqlDataAccessLayerEntityBuild
        : MSBuildLogsExtended.DALContracts.DataAccessLayerEntityContractBuild//<MSBuildLogsExtended.DataSourceEntities.BuildCollection, MSBuildLogsExtended.DataSourceEntities.Build, MSBuildLogsExtended.DataSourceEntities.BuildIdentifier>
    {
        ...
        /// </summary>
        public LinqToSqlDataAccessLayerEntityBuild()
        {
        }
        ...
        public LinqToSqlDataAccessLayerEntityBuild(MSBuildLogsExtended.LinqToSqlContexts.MSBuildLogsExtendedContext linqContext)
        {
        ...
        public MSBuildLogsExtended.DataSourceEntities.DataAccessLayerMessageOfEntityCollectionBuild Insert(MSBuildLogsExtended.DataSourceEntities.Build input)
        {
            ...
            if (input != null)
            {
                ...
                this.LinqContext.Build.InsertOnSubmit(_LinqItem);
        ...
        public MSBuildLogsExtended.DataSourceEntities.DataAccessLayerMessageOfEntityCollectionBuild Delete(MSBuildLogsExtended.DataSourceEntities.Build input)
        {
            ...
            if (input != null)
            {
                ...
                if (_LinqItem != null)
                {
                    this.LinqContext.Build.DeleteOnSubmit(_LinqItem);
                    this.LinqContext.SubmitChanges();
                }
            }
...
/*
            ...
            if (input != null)
            {
                List<MSBuildLogsExtended.LinqToSqlContexts.Build> _ListOfLinq = MSBuildLogsExtended.EntityContracts.IBuildHelper.CloneCollection
                    ...
                    >(input);
                this.LinqContext.Build.InsertAllOnSubmit<MSBuildLogsExtended.LinqToSqlContexts.Build>(_ListOfLinq);
                this.LinqContext.SubmitChanges();
...
*/
        ...
        public MSBuildLogsExtended.DataSourceEntities.DataAccessLayerMessageOfEntityCollectionBuild BatchDelete(MSBuildLogsExtended.DataSourceEntities.BuildCollection input)
        {
            ...
            if (input != null)
            {
                ...
                this.LinqContext.Build.DeleteAllOnSubmit<MSBuildLogsExtended.LinqToSqlContexts.Build>(_ListOfLinq);
                this.LinqContext.SubmitChanges();
            }
        ...
        private MSBuildLogsExtended.LinqToSqlContexts.Build GetLinqObjectByIdentifier(MSBuildLogsExtended.EntityContracts.IBuildIdentifier id)
        {
            ...
            return this.LinqContext.Build.SingleOrDefault<MSBuildLogsExtended.LinqToSqlContexts.Build>(m_Predicate);
        }
