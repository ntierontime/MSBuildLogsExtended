...
namespace MSBuildLogsExtended.LinqDAL
{
    ...
    /// 3. Queries
    /// </summary>
    public class LinqToSqlDataAccessLayerEntityBuildEventCode
        : MSBuildLogsExtended.DALContracts.DataAccessLayerEntityContractBuildEventCode//<MSBuildLogsExtended.DataSourceEntities.BuildEventCodeCollection, MSBuildLogsExtended.DataSourceEntities.BuildEventCode, MSBuildLogsExtended.DataSourceEntities.BuildEventCodeIdentifier>
    {
		#region for log4net
        ...
        /// </summary>
        public LinqToSqlDataAccessLayerEntityBuildEventCode()
        {
        }
        ...
        public LinqToSqlDataAccessLayerEntityBuildEventCode(MSBuildLogsExtended.LinqToSqlContexts.MSBuildLogsExtendedContext linqContext)
        {
        ...
        public MSBuildLogsExtended.DataSourceEntities.DataAccessLayerMessageOfEntityCollectionBuildEventCode Insert(MSBuildLogsExtended.DataSourceEntities.BuildEventCode input)
        {
            ...
            if (input != null)
            {
                MSBuildLogsExtended.LinqToSqlContexts.BuildEventCode _LinqItem = MSBuildLogsExtended.EntityContracts.IBuildEventCodeHelper.Clone<MSBuildLogsExtended.DataSourceEntities.BuildEventCode, MSBuildLogsExtended.LinqToSqlContexts.BuildEventCode>(input);
                this.LinqContext.BuildEventCode.InsertOnSubmit(_LinqItem);
                ...
                MSBuildLogsExtended.EntityContracts.IBuildEventCodeHelper.Copy<MSBuildLogsExtended.LinqToSqlContexts.BuildEventCode, MSBuildLogsExtended.DataSourceEntities.BuildEventCode>(_LinqItem, _Result);
        ...
        public MSBuildLogsExtended.DataSourceEntities.DataAccessLayerMessageOfEntityCollectionBuildEventCode Update(MSBuildLogsExtended.DataSourceEntities.BuildEventCode input)
        {
            ...
            if (input != null)
            {
                MSBuildLogsExtended.LinqToSqlContexts.BuildEventCode _LinqItem = GetLinqObjectByIdentifier(input);
                if (_LinqItem != null)
                {
                    //MSBuildLogsExtended.EntityContracts.IBuildEventCodeHelper.Copy<MSBuildLogsExtended.DataSourceEntities.BuildEventCode, MSBuildLogsExtended.LinqToSqlContexts.BuildEventCode>(input, _LinqItem);
                    _LinqItem.Id = input.Id;
                    _LinqItem.EventCode = input.EventCode;
        ...
        public MSBuildLogsExtended.DataSourceEntities.DataAccessLayerMessageOfEntityCollectionBuildEventCode Delete(MSBuildLogsExtended.DataSourceEntities.BuildEventCode input)
        {
            ...
            if (input != null)
            {
                ...
                if (_LinqItem != null)
                {
                    this.LinqContext.BuildEventCode.DeleteOnSubmit(_LinqItem);
                    this.LinqContext.SubmitChanges();
                }
            }
        ...
        public MSBuildLogsExtended.DataSourceEntities.DataAccessLayerMessageOfEntityCollectionBuildEventCode DeleteByIdentifier(MSBuildLogsExtended.DataSourceEntities.BuildEventCodeIdentifier id)
        {
            ...
            if (id != null)
            {
                MSBuildLogsExtended.LinqToSqlContexts.BuildEventCode _LinqItem = GetLinqObjectByIdentifier(id);
                if (_LinqItem != null)
                {
					...
					MSBuildLogsExtended.EntityContracts.IBuildEventCodeHelper.Copy<MSBuildLogsExtended.LinqToSqlContexts.BuildEventCode, MSBuildLogsExtended.DataSourceEntities.BuildEventCode>(_LinqItem, _Original);
...
/*
            ...
            if (input != null)
            {
                List<MSBuildLogsExtended.LinqToSqlContexts.BuildEventCode> _ListOfLinq = MSBuildLogsExtended.EntityContracts.IBuildEventCodeHelper.CloneCollection
                    <
                        MSBuildLogsExtended.DataSourceEntities.BuildEventCodeCollection, List<MSBuildLogsExtended.LinqToSqlContexts.BuildEventCode>,
                        MSBuildLogsExtended.DataSourceEntities.BuildEventCode, MSBuildLogsExtended.LinqToSqlContexts.BuildEventCode
                    >(input);
                this.LinqContext.BuildEventCode.InsertAllOnSubmit<MSBuildLogsExtended.LinqToSqlContexts.BuildEventCode>(_ListOfLinq);
                this.LinqContext.SubmitChanges();
                for (int i = 0; i < input.Count; i++)
                {
                    MSBuildLogsExtended.EntityContracts.IBuildEventCodeHelper.Copy
                        <
                            MSBuildLogsExtended.LinqToSqlContexts.BuildEventCode, MSBuildLogsExtended.DataSourceEntities.BuildEventCode
...
*/
        ...
        public MSBuildLogsExtended.DataSourceEntities.DataAccessLayerMessageOfEntityCollectionBuildEventCode BatchDelete(MSBuildLogsExtended.DataSourceEntities.BuildEventCodeCollection input)
        {
            ...
            if (input != null)
            {
                List<MSBuildLogsExtended.LinqToSqlContexts.BuildEventCode> _ListOfLinq = new List<MSBuildLogsExtended.LinqToSqlContexts.BuildEventCode>();
                foreach (MSBuildLogsExtended.DataSourceEntities.BuildEventCode _ItemOfInput in input)
                {
                    MSBuildLogsExtended.LinqToSqlContexts.BuildEventCode _LinqItem = GetLinqObjectByIdentifier(_ItemOfInput);
                    MSBuildLogsExtended.EntityContracts.IBuildEventCodeHelper.Copy<MSBuildLogsExtended.DataSourceEntities.BuildEventCode, MSBuildLogsExtended.LinqToSqlContexts.BuildEventCode>(_ItemOfInput, _LinqItem);
                    _ListOfLinq.Add(_LinqItem);
                }
                this.LinqContext.BuildEventCode.DeleteAllOnSubmit<MSBuildLogsExtended.LinqToSqlContexts.BuildEventCode>(_ListOfLinq);
                this.LinqContext.SubmitChanges();
            }
        ...
        {
            MSBuildLogsExtended.LinqToSqlContexts.BuildEventCode _Only = GetLinqObjectByIdentifier(id);
            if (_Only != null)
            {
        ...
        /// </summary>
        /// <param name="id">The id.</param>
        /// <returns>an instance of <see cref="MSBuildLogsExtended.LinqToSqlContexts.BuildEventCode"/> class, with same identifier, which is a IQueryable.</returns>
        private MSBuildLogsExtended.LinqToSqlContexts.BuildEventCode GetLinqObjectByIdentifier(MSBuildLogsExtended.EntityContracts.IBuildEventCodeIdentifier id)
        {
            Func<MSBuildLogsExtended.LinqToSqlContexts.BuildEventCode, bool> m_Predicate = (MSBuildLogsExtended.LinqToSqlContexts.BuildEventCode t) =>
            {
                return MSBuildLogsExtended.EntityContracts.IBuildEventCodeIdentifierHelper.Equals<MSBuildLogsExtended.EntityContracts.IBuildEventCodeIdentifier, MSBuildLogsExtended.LinqToSqlContexts.BuildEventCode>(id, t);
            };

            return this.LinqContext.BuildEventCode.SingleOrDefault<MSBuildLogsExtended.LinqToSqlContexts.BuildEventCode>(m_Predicate);
        }
			...
			)
        {
			var _ResultFromDataSource = 
				(
					from t in this.LinqContext.BuildEventCode
					where
						(
							(
			...
			)
        {
			var _ResultFromDataSource = 
				(
					...
					select new MSBuildLogsExtended.DataSourceEntities.BuildEventCode.KeyInformation { Id = t.Id } into vD2
					select vD2
				);
			var _retval = _ResultFromDataSource;
