...
namespace MSBuildLogsExtended.LinqDAL
{
    ...
    /// 3. Queries
    /// </summary>
    public class LinqToSqlDataAccessLayerEntityBuildLog
        : MSBuildLogsExtended.DALContracts.DataAccessLayerEntityContractBuildLog//<MSBuildLogsExtended.DataSourceEntities.BuildLogCollection, MSBuildLogsExtended.DataSourceEntities.BuildLog, MSBuildLogsExtended.DataSourceEntities.BuildLogIdentifier>
    {
		#region for log4net
        ...
        /// </summary>
        public LinqToSqlDataAccessLayerEntityBuildLog()
        {
        }
        ...
        public LinqToSqlDataAccessLayerEntityBuildLog(MSBuildLogsExtended.LinqToSqlContexts.MSBuildLogsExtendedContext linqContext)
        {
        ...
        public MSBuildLogsExtended.DataSourceEntities.DataAccessLayerMessageOfEntityCollectionBuildLog Insert(MSBuildLogsExtended.DataSourceEntities.BuildLog input)
        {
            ...
            if (input != null)
            {
                MSBuildLogsExtended.LinqToSqlContexts.BuildLog _LinqItem = MSBuildLogsExtended.EntityContracts.IBuildLogHelper.Clone<MSBuildLogsExtended.DataSourceEntities.BuildLog, MSBuildLogsExtended.LinqToSqlContexts.BuildLog>(input);
                this.LinqContext.BuildLog.InsertOnSubmit(_LinqItem);
        ...
        public MSBuildLogsExtended.DataSourceEntities.DataAccessLayerMessageOfEntityCollectionBuildLog Delete(MSBuildLogsExtended.DataSourceEntities.BuildLog input)
        {
            ...
            if (input != null)
            {
                ...
                if (_LinqItem != null)
                {
                    this.LinqContext.BuildLog.DeleteOnSubmit(_LinqItem);
                    this.LinqContext.SubmitChanges();
                }
            }
        ...
        public MSBuildLogsExtended.DataSourceEntities.DataAccessLayerMessageOfEntityCollectionBuildLog DeleteByIdentifier(MSBuildLogsExtended.DataSourceEntities.BuildLogIdentifier id)
        {
            ...
            if (id != null)
            {
                MSBuildLogsExtended.LinqToSqlContexts.BuildLog _LinqItem = GetLinqObjectByIdentifier(id);
                if (_LinqItem != null)
                {
					MSBuildLogsExtended.DataSourceEntities.BuildLog _Original = new MSBuildLogsExtended.DataSourceEntities.BuildLog();
					MSBuildLogsExtended.EntityContracts.IBuildLogHelper.Copy<MSBuildLogsExtended.LinqToSqlContexts.BuildLog, MSBuildLogsExtended.DataSourceEntities.BuildLog>(_LinqItem, _Original);
...
/*
            ...
            if (input != null)
            {
                List<MSBuildLogsExtended.LinqToSqlContexts.BuildLog> _ListOfLinq = MSBuildLogsExtended.EntityContracts.IBuildLogHelper.CloneCollection
                    <
                        MSBuildLogsExtended.DataSourceEntities.BuildLogCollection, List<MSBuildLogsExtended.LinqToSqlContexts.BuildLog>,
                        MSBuildLogsExtended.DataSourceEntities.BuildLog, MSBuildLogsExtended.LinqToSqlContexts.BuildLog
                    >(input);
                this.LinqContext.BuildLog.InsertAllOnSubmit<MSBuildLogsExtended.LinqToSqlContexts.BuildLog>(_ListOfLinq);
                this.LinqContext.SubmitChanges();
                for (int i = 0; i < input.Count; i++)
                {
                    MSBuildLogsExtended.EntityContracts.IBuildLogHelper.Copy
                        <
                            MSBuildLogsExtended.LinqToSqlContexts.BuildLog, MSBuildLogsExtended.DataSourceEntities.BuildLog
...
*/
        ...
        public MSBuildLogsExtended.DataSourceEntities.DataAccessLayerMessageOfEntityCollectionBuildLog BatchDelete(MSBuildLogsExtended.DataSourceEntities.BuildLogCollection input)
        {
            ...
            if (input != null)
            {
                List<MSBuildLogsExtended.LinqToSqlContexts.BuildLog> _ListOfLinq = new List<MSBuildLogsExtended.LinqToSqlContexts.BuildLog>();
                foreach (MSBuildLogsExtended.DataSourceEntities.BuildLog _ItemOfInput in input)
                {
                    MSBuildLogsExtended.LinqToSqlContexts.BuildLog _LinqItem = GetLinqObjectByIdentifier(_ItemOfInput);
                    MSBuildLogsExtended.EntityContracts.IBuildLogHelper.Copy<MSBuildLogsExtended.DataSourceEntities.BuildLog, MSBuildLogsExtended.LinqToSqlContexts.BuildLog>(_ItemOfInput, _LinqItem);
                    _ListOfLinq.Add(_LinqItem);
                }
                this.LinqContext.BuildLog.DeleteAllOnSubmit<MSBuildLogsExtended.LinqToSqlContexts.BuildLog>(_ListOfLinq);
                this.LinqContext.SubmitChanges();
            }
        ...
        {
            MSBuildLogsExtended.LinqToSqlContexts.BuildLog _Only = GetLinqObjectByIdentifier(id);
            if (_Only != null)
            {
        ...
        /// </summary>
        /// <param name="id">The id.</param>
        /// <returns>an instance of <see cref="MSBuildLogsExtended.LinqToSqlContexts.BuildLog"/> class, with same identifier, which is a IQueryable.</returns>
        private MSBuildLogsExtended.LinqToSqlContexts.BuildLog GetLinqObjectByIdentifier(MSBuildLogsExtended.EntityContracts.IBuildLogIdentifier id)
        {
            Func<MSBuildLogsExtended.LinqToSqlContexts.BuildLog, bool> m_Predicate = (MSBuildLogsExtended.LinqToSqlContexts.BuildLog t) =>
            {
                return MSBuildLogsExtended.EntityContracts.IBuildLogIdentifierHelper.Equals<MSBuildLogsExtended.EntityContracts.IBuildLogIdentifier, MSBuildLogsExtended.LinqToSqlContexts.BuildLog>(id, t);
            };

            return this.LinqContext.BuildLog.SingleOrDefault<MSBuildLogsExtended.LinqToSqlContexts.BuildLog>(m_Predicate);
        }
        ...
        internal IQueryable<MSBuildLogsExtended.DataSourceEntities.BuildLog> _GetQueryOfEntityOfCommon(
			Framework.EntityContracts.QuerySystemInt64EqualsCriteria criteriaOfIdOfBuild_B1_1OfCommonOfCommonOfCommon
			,Framework.EntityContracts.QuerySystemInt32EqualsCriteria criteriaOfIdOfSolution_S1_1OfCommonOfCommonOfCommon
			,Framework.EntityContracts.QuerySystemInt32EqualsCriteria criteriaOfIdOfBuildEventCode_B2_1OfCommonOfCommonOfCommon
			...
			)
        {
			var _ResultFromDataSource = 
				(
					from t in this.LinqContext.BuildLog
					join Build_B1_1 in this.LinqContext.Build on t.BuildId equals Build_B1_1.Id
					join Solution_S1_1 in this.LinqContext.Solution on Build_B1_1.SolutionId equals Solution_S1_1.Id
					join BuildEventCode_B2_1 in this.LinqContext.BuildEventCode on t.BuildEventCodeId equals BuildEventCode_B2_1.Id
					where
						(
							(
							(criteriaOfIdOfBuild_B1_1OfCommonOfCommonOfCommon.IsToCompare == false || criteriaOfIdOfBuild_B1_1OfCommonOfCommonOfCommon.IsToCompare && Build_B1_1.Id == criteriaOfIdOfBuild_B1_1OfCommonOfCommonOfCommon.ValueToCompare)
							 &&
							(criteriaOfIdOfSolution_S1_1OfCommonOfCommonOfCommon.IsToCompare == false || criteriaOfIdOfSolution_S1_1OfCommonOfCommonOfCommon.IsToCompare && Solution_S1_1.Id == criteriaOfIdOfSolution_S1_1OfCommonOfCommonOfCommon.ValueToCompare)
							 &&
							(criteriaOfIdOfBuildEventCode_B2_1OfCommonOfCommonOfCommon.IsToCompare == false || criteriaOfIdOfBuildEventCode_B2_1OfCommonOfCommonOfCommon.IsToCompare && BuildEventCode_B2_1.Id == criteriaOfIdOfBuildEventCode_B2_1OfCommonOfCommonOfCommon.ValueToCompare)
							 &&
			...
			)
        {
            int _Count = _GetCountOfEntityOfCommon(
				criteriaOfIdOfBuild_B1_1OfCommonOfCommonOfCommon
			...
			)
        {
			var _ResultFromDataSource = 
				(
					...
					select new MSBuildLogsExtended.DataSourceEntities.BuildLog.Default { Id = t.Id, BuildId = t.BuildId, BuildEventCodeId = t.BuildEventCodeId, Message = t.Message, EventTime = t.EventTime, Build_B1_1_Name = Build_B1_1.Name, Solution_S1_1_Name = Solution_S1_1.Name, Solution_S1_1Id = Solution_S1_1.Id, BuildEventCode_B2_1_Name = BuildEventCode_B2_1.EventCode } into vD2
					select vD2
				);
        ...
        internal IQueryable<MSBuildLogsExtended.DataSourceEntities.BuildLog> _GetQueryOfEntityOfByFKOnly(
			Framework.EntityContracts.QuerySystemInt64EqualsCriteria criteriaOfIdOfBuild_B1_1OfByFKOnlyOfByFKOnlyOfByFKOnly
			,Framework.EntityContracts.QuerySystemInt32EqualsCriteria criteriaOfIdOfSolution_S1_1OfByFKOnlyOfByFKOnlyOfByFKOnly
			,Framework.EntityContracts.QuerySystemInt32EqualsCriteria criteriaOfIdOfBuildEventCode_B2_1OfByFKOnlyOfByFKOnlyOfByFKOnly
			,Framework.EntityContracts.QueryOrderBySettingCollection queryOrderBySettingCollection
			)
        {
			var _ResultFromDataSource = 
				(
					...
					where
						(
							(
							(criteriaOfIdOfBuild_B1_1OfByFKOnlyOfByFKOnlyOfByFKOnly.IsToCompare == false || criteriaOfIdOfBuild_B1_1OfByFKOnlyOfByFKOnlyOfByFKOnly.IsToCompare && Build_B1_1.Id == criteriaOfIdOfBuild_B1_1OfByFKOnlyOfByFKOnlyOfByFKOnly.ValueToCompare)
							 &&
							(criteriaOfIdOfSolution_S1_1OfByFKOnlyOfByFKOnlyOfByFKOnly.IsToCompare == false || criteriaOfIdOfSolution_S1_1OfByFKOnlyOfByFKOnlyOfByFKOnly.IsToCompare && Solution_S1_1.Id == criteriaOfIdOfSolution_S1_1OfByFKOnlyOfByFKOnlyOfByFKOnly.ValueToCompare)
							 &&
							(criteriaOfIdOfBuildEventCode_B2_1OfByFKOnlyOfByFKOnlyOfByFKOnly.IsToCompare == false || criteriaOfIdOfBuildEventCode_B2_1OfByFKOnlyOfByFKOnlyOfByFKOnly.IsToCompare && BuildEventCode_B2_1.Id == criteriaOfIdOfBuildEventCode_B2_1OfByFKOnlyOfByFKOnlyOfByFKOnly.ValueToCompare)
							)
						)
					select new MSBuildLogsExtended.DataSourceEntities.BuildLog { Id = t.Id, BuildId = t.BuildId, BuildEventCodeId = t.BuildEventCodeId, Message = t.Message, EventTime = t.EventTime } into x
					select x
			...
			)
        {
            int _Count = _GetCountOfEntityOfByFKOnly(
				criteriaOfIdOfBuild_B1_1OfByFKOnlyOfByFKOnlyOfByFKOnly
				,criteriaOfIdOfSolution_S1_1OfByFKOnlyOfByFKOnlyOfByFKOnly
				,criteriaOfIdOfBuildEventCode_B2_1OfByFKOnlyOfByFKOnlyOfByFKOnly
				,currentIndex
				,pageSize
				,queryOrderBySettingCollection
			);
			...
			)
        {
			var _ResultFromDataSource = 
				(
					...
					group t by new { BuildId = t.BuildId, BuildEventCodeId = t.BuildEventCodeId, Solution_S1_1Id = Solution_S1_1.Id, Name = string.Format("{0} - {1} - {2}", Build_B1_1.Name, Solution_S1_1.ExternalParentId, BuildEventCode_B2_1.EventCode) } into tG
					let _CountPerFK = tG.Count()
					select new MSBuildLogsExtended.DataSourceEntities.BuildLog.DefaultGroupedDataView { BuildId = tG.Key.BuildId, BuildEventCodeId = tG.Key.BuildEventCodeId, Solution_S1_1Id = tG.Key.Solution_S1_1Id, CountPerFK = _CountPerFK, Name = tG.Key.Name } into vD3
					select vD3
				);
			var _retval = _ResultFromDataSource;
			...
			)
        {
			var _ResultFromDataSource = 
				(
					...
					select new MSBuildLogsExtended.DataSourceEntities.BuildLog.KeyInformation { Id = t.Id } into vD4
					select vD4
				);
			var _retval = _ResultFromDataSource;
