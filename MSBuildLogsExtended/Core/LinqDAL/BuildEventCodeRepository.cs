...
namespace MSBuildLogsExtended.LinqDAL
{
        ...
        : MSBuildLogsExtended.DALContracts.IBuildEventCodeRepository//<MSBuildLogsExtended.DataSourceEntities.BuildEventCodeCollection, MSBuildLogsExtended.DataSourceEntities.BuildEventCode, MSBuildLogsExtended.DataSourceEntities.BuildEventCodeIdentifier>
    {
        ...
        public BuildEventCodeRepository(MSBuildLogsExtended.LinqToSqlContexts.MSBuildLogsExtendedContext linqContext)
        {
        ...
        public MSBuildLogsExtended.DataSourceEntities.DataAccessLayerMessageOfEntityCollectionBuildEventCode Insert(MSBuildLogsExtended.DataSourceEntities.BuildEventCode input)
        {
            ...
            if (input != null)
            {
                ...
                this.LinqContext.BuildEventCodes.InsertOnSubmit(_LinqItem);
        ...
        public MSBuildLogsExtended.DataSourceEntities.DataAccessLayerMessageOfEntityCollectionBuildEventCode Delete(MSBuildLogsExtended.DataSourceEntities.BuildEventCode input)
        {
            ...
            if (input != null)
            {
                ...
                if (_LinqItem != null)
                {
                    this.LinqContext.BuildEventCodes.DeleteOnSubmit(_LinqItem);
                    this.LinqContext.SubmitChanges();
                }
            }
...
/*
            ...
            if (input != null)
            {
                List<MSBuildLogsExtended.LinqToSqlContexts.BuildEventCode> _ListOfLinq = MSBuildLogsExtended.EntityContracts.IBuildEventCodeHelper.CloneCollection
                    ...
                    >(input);
                this.LinqContext.BuildEventCodes.InsertAllOnSubmit<MSBuildLogsExtended.LinqToSqlContexts.BuildEventCode>(_ListOfLinq);
                this.LinqContext.SubmitChanges();
...
*/
        ...
        public MSBuildLogsExtended.DataSourceEntities.DataAccessLayerMessageOfEntityCollectionBuildEventCode BatchDelete(MSBuildLogsExtended.DataSourceEntities.BuildEventCodeCollection input)
        {
            ...
            if (input != null)
            {
                ...
                this.LinqContext.BuildEventCodes.DeleteAllOnSubmit<MSBuildLogsExtended.LinqToSqlContexts.BuildEventCode>(_ListOfLinq);
                this.LinqContext.SubmitChanges();
            }
        ...
        private MSBuildLogsExtended.LinqToSqlContexts.BuildEventCode GetLinqObjectByIdentifier(MSBuildLogsExtended.EntityContracts.IBuildEventCodeIdentifier id)
        {
            ...
            return this.LinqContext.BuildEventCodes.SingleOrDefault<MSBuildLogsExtended.LinqToSqlContexts.BuildEventCode>(m_Predicate);
        }
