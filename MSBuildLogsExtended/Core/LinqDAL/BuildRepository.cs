...
namespace MSBuildLogsExtended.LinqDAL
{
    ...
    public class BuildRepository
        : MSBuildLogsExtended.DALContracts.IBuildRepository//<MSBuildLogsExtended.DataSourceEntities.BuildCollection, MSBuildLogsExtended.DataSourceEntities.Build, MSBuildLogsExtended.DataSourceEntities.BuildIdentifier>
    {
		#region for log4net
        ...
        public BuildRepository(MSBuildLogsExtended.LinqToSqlContexts.MSBuildLogsExtendedContext linqContext)
        {
        ...
        public MSBuildLogsExtended.DataSourceEntities.DataAccessLayerMessageOfEntityCollectionBuild Insert(MSBuildLogsExtended.DataSourceEntities.Build input)
        {
            ...
            if (input != null)
            {
                MSBuildLogsExtended.LinqToSqlContexts.Build _LinqItem = MSBuildLogsExtended.EntityContracts.IBuildHelper.Clone<MSBuildLogsExtended.DataSourceEntities.Build, MSBuildLogsExtended.LinqToSqlContexts.Build>(input);
                this.LinqContext.Builds.InsertOnSubmit(_LinqItem);
        ...
        public MSBuildLogsExtended.DataSourceEntities.DataAccessLayerMessageOfEntityCollectionBuild Delete(MSBuildLogsExtended.DataSourceEntities.Build input)
        {
            ...
            if (input != null)
            {
                ...
                if (_LinqItem != null)
                {
                    this.LinqContext.Builds.DeleteOnSubmit(_LinqItem);
                    this.LinqContext.SubmitChanges();
                }
            }
        ...
        public MSBuildLogsExtended.DataSourceEntities.DataAccessLayerMessageOfEntityCollectionBuild DeleteByIdentifier(MSBuildLogsExtended.DataSourceEntities.BuildIdentifier id)
        {
            ...
            if (id != null)
            {
                MSBuildLogsExtended.LinqToSqlContexts.Build _LinqItem = GetLinqObjectByIdentifier(id);
                if (_LinqItem != null)
                {
					MSBuildLogsExtended.DataSourceEntities.Build _Original = new MSBuildLogsExtended.DataSourceEntities.Build();
					MSBuildLogsExtended.EntityContracts.IBuildHelper.Copy<MSBuildLogsExtended.LinqToSqlContexts.Build, MSBuildLogsExtended.DataSourceEntities.Build>(_LinqItem, _Original);
...
/*
            ...
            if (input != null)
            {
                List<MSBuildLogsExtended.LinqToSqlContexts.Build> _ListOfLinq = MSBuildLogsExtended.EntityContracts.IBuildHelper.CloneCollection
                    <
                        MSBuildLogsExtended.DataSourceEntities.BuildCollection, List<MSBuildLogsExtended.LinqToSqlContexts.Build>,
                        MSBuildLogsExtended.DataSourceEntities.Build, MSBuildLogsExtended.LinqToSqlContexts.Build
                    >(input);
                this.LinqContext.Builds.InsertAllOnSubmit<MSBuildLogsExtended.LinqToSqlContexts.Build>(_ListOfLinq);
                this.LinqContext.SubmitChanges();
                for (int i = 0; i < input.Count; i++)
                {
                    MSBuildLogsExtended.EntityContracts.IBuildHelper.Copy
                        <
                            MSBuildLogsExtended.LinqToSqlContexts.Build, MSBuildLogsExtended.DataSourceEntities.Build
...
*/
        ...
        public MSBuildLogsExtended.DataSourceEntities.DataAccessLayerMessageOfEntityCollectionBuild BatchDelete(MSBuildLogsExtended.DataSourceEntities.BuildCollection input)
        {
            ...
            if (input != null)
            {
                List<MSBuildLogsExtended.LinqToSqlContexts.Build> _ListOfLinq = new List<MSBuildLogsExtended.LinqToSqlContexts.Build>();
                foreach (MSBuildLogsExtended.DataSourceEntities.Build _ItemOfInput in input)
                {
                    MSBuildLogsExtended.LinqToSqlContexts.Build _LinqItem = GetLinqObjectByIdentifier(_ItemOfInput);
                    MSBuildLogsExtended.EntityContracts.IBuildHelper.Copy<MSBuildLogsExtended.DataSourceEntities.Build, MSBuildLogsExtended.LinqToSqlContexts.Build>(_ItemOfInput, _LinqItem);
                    _ListOfLinq.Add(_LinqItem);
                }
                this.LinqContext.Builds.DeleteAllOnSubmit<MSBuildLogsExtended.LinqToSqlContexts.Build>(_ListOfLinq);
                this.LinqContext.SubmitChanges();
            }
        ...
        {
            MSBuildLogsExtended.LinqToSqlContexts.Build _Only = GetLinqObjectByIdentifier(id);
            if (_Only != null)
            {
        ...
        /// </summary>
        /// <param name="id">The id.</param>
        /// <returns>an instance of <see cref="MSBuildLogsExtended.LinqToSqlContexts.Build"/> class, with same identifier, which is a IQueryable.</returns>
        private MSBuildLogsExtended.LinqToSqlContexts.Build GetLinqObjectByIdentifier(MSBuildLogsExtended.EntityContracts.IBuildIdentifier id)
        {
            Func<MSBuildLogsExtended.LinqToSqlContexts.Build, bool> m_Predicate = (MSBuildLogsExtended.LinqToSqlContexts.Build t) =>
            {
                return MSBuildLogsExtended.EntityContracts.IBuildIdentifierHelper.Equals<MSBuildLogsExtended.EntityContracts.IBuildIdentifier, MSBuildLogsExtended.LinqToSqlContexts.Build>(id, t);
            };

            return this.LinqContext.Builds.SingleOrDefault<MSBuildLogsExtended.LinqToSqlContexts.Build>(m_Predicate);
        }
			...
			)
        {
			var _ResultFromDataSource = 
				(
					...
					select new MSBuildLogsExtended.DataSourceEntities.Build.Default { Id = t.Id, SolutionId = t.SolutionId, Name = t.Name, Description = t.Description, BuildStartTime = t.BuildStartTime, Solution_1_Name = Solution_1.Name } into vD2
					select vD2
				);
        ...
        /// <param name="queryOrderBySettingCollection">query OrderBy setting</param>
        /// <returns>IQueryable&lt;...&gt; of Common</returns>
        internal IQueryable<MSBuildLogsExtended.DataSourceEntities.Build.UpdateNameRequest> _GetQueryOfUpdateNameRequestOfByIdentifier(
			Framework.EntityContracts.QuerySystemInt64EqualsCriteria criteriaOfIdOftOfByIdentifierOfByIdentifierOfByIdentifier
			,Framework.EntityContracts.QueryOrderBySettingCollection queryOrderBySettingCollection
			)
        {
			var _ResultFromDataSource = 
				(
					...
					select new MSBuildLogsExtended.DataSourceEntities.Build.UpdateNameRequest { Name = t.Name, Id = t.Id } into vD4
					select vD4
				);
			var _retval = _ResultFromDataSource;
            IQueryable<MSBuildLogsExtended.DataSourceEntities.Build.UpdateNameRequest> _retval1;
            if (queryOrderBySettingCollection == null || queryOrderBySettingCollection.Count == 0)
            {
                _retval1 = _retval;
            }
        ...
        {
            IQueryable<MSBuildLogsExtended.DataSourceEntities.Build.UpdateNameRequest> _Query = _GetQueryOfUpdateNameRequestOfByIdentifier(
				criteriaOfIdOftOfByIdentifierOfByIdentifierOfByIdentifier
				,queryOrderBySettingCollection
			);
            int _Count;
        ...
        /// <param name="queryOrderBySettingCollection">query OrderBy setting</param>
        /// <returns>result message with single entity</returns>
        public MSBuildLogsExtended.DataSourceEntities.Build.DataAccessLayerMessageOfUpdateNameRequest GetSingleOfUpdateNameRequestOfByIdentifier(
			Framework.EntityContracts.QuerySystemInt64EqualsCriteria criteriaOfIdOftOfByIdentifierOfByIdentifierOfByIdentifier
			,Framework.EntityContracts.QueryOrderBySettingCollection queryOrderBySettingCollection
			)
        {
            ...
            MSBuildLogsExtended.DataSourceEntities.Build.DataAccessLayerMessageOfUpdateNameRequest _retMessage = new MSBuildLogsExtended.DataSourceEntities.Build.DataAccessLayerMessageOfUpdateNameRequest();
            try
            {
				...
				,queryOrderBySettingCollection
                    ...
                    MSBuildLogsExtended.DataSourceEntities.Build.UpdateNameRequest _retval = _Query.SingleOrDefault();
        ...
        /// <param name="queryOrderBySettingCollection">query OrderBy setting</param>
        /// <returns>result message with entity collection</returns>
        public MSBuildLogsExtended.DataSourceEntities.Build.DataAccessLayerMessageOfUpdateNameRequestCollection GetCollectionOfUpdateNameRequestOfByIdentifier(
			Framework.EntityContracts.QuerySystemInt64EqualsCriteria criteriaOfIdOftOfByIdentifierOfByIdentifierOfByIdentifier
			,int currentIndex
			,int pageSize
			,Framework.EntityContracts.QueryOrderBySettingCollection queryOrderBySettingCollection
			)
        {
            ...
            MSBuildLogsExtended.DataSourceEntities.Build.DataAccessLayerMessageOfUpdateNameRequestCollection _retMessage = new MSBuildLogsExtended.DataSourceEntities.Build.DataAccessLayerMessageOfUpdateNameRequestCollection();
            try
            {
                bool _Exists = _ExistsOfUpdateNameRequestOfByIdentifier(
				criteriaOfIdOftOfByIdentifierOfByIdentifierOfByIdentifier
				...
				,queryOrderBySettingCollection
                    ...
                    IEnumerable<MSBuildLogsExtended.DataSourceEntities.Build.UpdateNameRequest> _retval;
                    ...
                    _retMessage.QueryPagingResult.CurrentIndexOfStartRecord = currentIndex;
                    _retMessage.QueryPagingResult.CountOfRecords = _Query.Count();
                    _retMessage.Result = new MSBuildLogsExtended.DataSourceEntities.Build.UpdateNameRequestCollection();
					_retMessage.Result.AddRange(_retval);
			...
			)
        {
			var _ResultFromDataSource = 
				(
					...
					select new MSBuildLogsExtended.DataSourceEntities.Build.KeyInformation { Id = t.Id, Name = t.Name } into vD5
					select vD5
				);
			var _retval = _ResultFromDataSource;
        ...
        public MSBuildLogsExtended.DataSourceEntities.Build.DataAccessLayerMessageOfUpdateNameRequest UpdateNameOnly(MSBuildLogsExtended.DataSourceEntities.Build.UpdateNameRequest input)
        {
            log.Info(string.Format("{0}: UpdateNameOnly", Framework.LoggingOptions.Data_Access_Layer_Process_Started.ToString()));

            MSBuildLogsExtended.DataSourceEntities.Build.DataAccessLayerMessageOfUpdateNameRequest _retval = new MSBuildLogsExtended.DataSourceEntities.Build.DataAccessLayerMessageOfUpdateNameRequest();
            _retval.OriginalValue = input;
            try
            {
                if (input != null)
