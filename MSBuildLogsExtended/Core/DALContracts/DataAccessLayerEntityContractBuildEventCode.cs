...
namespace MSBuildLogsExtended.DALContracts
{
    ...
    public interface DataAccessLayerEntityContractBuildEventCode<TCollection, T, TIdentifier, TCollectionMessage>
