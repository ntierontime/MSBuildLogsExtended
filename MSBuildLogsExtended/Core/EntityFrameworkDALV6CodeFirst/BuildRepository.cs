...
namespace MSBuildLogsExtended.EntityFrameworkDAL
{
        ...
        : MSBuildLogsExtended.DALContracts.IBuildRepository//<MSBuildLogsExtended.DataSourceEntities.BuildCollection, MSBuildLogsExtended.DataSourceEntities.Build, MSBuildLogsExtended.DataSourceEntities.BuildIdentifier>
    {
        ...
        public BuildRepository(MSBuildLogsExtended.EntityFrameworkContext.MSBuildLogsExtendedEntities linqContext)
        {
        ...
        private MSBuildLogsExtended.EntityFrameworkContext.Build GetLinqObjectByIdentifier(MSBuildLogsExtended.EntityContracts.IBuildIdentifier id)
        {
            ...
            return this.LinqContext.Builds.SingleOrDefault<MSBuildLogsExtended.EntityFrameworkContext.Build>(m_Predicate);
        }
