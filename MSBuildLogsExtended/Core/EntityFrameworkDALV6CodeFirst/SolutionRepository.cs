...
namespace MSBuildLogsExtended.EntityFrameworkDAL
{
    ...
    public class SolutionRepository
        : MSBuildLogsExtended.DALContracts.ISolutionRepository//<MSBuildLogsExtended.DataSourceEntities.SolutionCollection, MSBuildLogsExtended.DataSourceEntities.Solution, MSBuildLogsExtended.DataSourceEntities.SolutionIdentifier>
    {
		#region for log4net
        ...
        public SolutionRepository(MSBuildLogsExtended.EntityFrameworkContext.MSBuildLogsExtendedEntities linqContext)
        {
        ...
        public MSBuildLogsExtended.DataSourceEntities.DataAccessLayerMessageOfEntityCollectionSolution Insert(MSBuildLogsExtended.DataSourceEntities.Solution input)
        {
            ...
            if (input != null)
            {
                MSBuildLogsExtended.EntityFrameworkContext.Solution _LinqItem = MSBuildLogsExtended.EntityContracts.ISolutionHelper.Clone<MSBuildLogsExtended.DataSourceEntities.Solution, MSBuildLogsExtended.EntityFrameworkContext.Solution>(input);
                ...
                MSBuildLogsExtended.EntityContracts.ISolutionHelper.Copy<MSBuildLogsExtended.EntityFrameworkContext.Solution, MSBuildLogsExtended.DataSourceEntities.Solution>(_LinqItem, _Result);
        ...
        public MSBuildLogsExtended.DataSourceEntities.DataAccessLayerMessageOfEntityCollectionSolution Update(MSBuildLogsExtended.DataSourceEntities.Solution input)
        {
            ...
            if (input != null)
            {
                MSBuildLogsExtended.EntityFrameworkContext.Solution _LinqItem = GetLinqObjectByIdentifier(input);
                if (_LinqItem != null)
                {
                    MSBuildLogsExtended.EntityContracts.ISolutionHelper.Copy<MSBuildLogsExtended.DataSourceEntities.Solution, MSBuildLogsExtended.EntityFrameworkContext.Solution>(input, _LinqItem);
                    this.LinqContext.SaveChanges();
					MSBuildLogsExtended.DataSourceEntities.Solution _Result = new MSBuildLogsExtended.DataSourceEntities.Solution();
					MSBuildLogsExtended.EntityContracts.ISolutionHelper.Copy<MSBuildLogsExtended.EntityFrameworkContext.Solution, MSBuildLogsExtended.DataSourceEntities.Solution>(_LinqItem, _Result);
					_retval.Result = new MSBuildLogsExtended.DataSourceEntities.SolutionCollection();
        ...
        public MSBuildLogsExtended.DataSourceEntities.DataAccessLayerMessageOfEntityCollectionSolution DeleteByIdentifier(MSBuildLogsExtended.DataSourceEntities.SolutionIdentifier id)
        {
            ...
            if (id != null)
            {
                MSBuildLogsExtended.EntityFrameworkContext.Solution _LinqItem = GetLinqObjectByIdentifier(id);
                if (_LinqItem != null)
                {
					MSBuildLogsExtended.DataSourceEntities.Solution _Original = new MSBuildLogsExtended.DataSourceEntities.Solution();
					MSBuildLogsExtended.EntityContracts.ISolutionHelper.Copy<MSBuildLogsExtended.EntityFrameworkContext.Solution, MSBuildLogsExtended.DataSourceEntities.Solution>(_LinqItem, _Original);
        ...
        public MSBuildLogsExtended.DataSourceEntities.DataAccessLayerMessageOfEntityCollectionSolution BatchDelete(MSBuildLogsExtended.DataSourceEntities.SolutionCollection input)
        {
            ...
            if (input != null)
            {
                List<MSBuildLogsExtended.EntityFrameworkContext.Solution> _ListOfLinq = new List<MSBuildLogsExtended.EntityFrameworkContext.Solution>();
                foreach (MSBuildLogsExtended.DataSourceEntities.Solution _ItemOfInput in input)
                {
                    MSBuildLogsExtended.EntityFrameworkContext.Solution _LinqItem = GetLinqObjectByIdentifier(_ItemOfInput);	
					this.LinqContext.Solutions.Remove(_LinqItem);
                }
                this.LinqContext.SaveChanges();
            }
        ...
        public MSBuildLogsExtended.DataSourceEntities.DataAccessLayerMessageOfEntityCollectionSolution BatchUpdate(MSBuildLogsExtended.DataSourceEntities.SolutionCollection input)
        {
            ...
            if (input != null)
            {
                ...
                {
                    MSBuildLogsExtended.EntityFrameworkContext.Solution _LinqItem = GetLinqObjectByIdentifier(_ItemOfInput);
                    MSBuildLogsExtended.EntityContracts.ISolutionHelper.Copy<MSBuildLogsExtended.DataSourceEntities.Solution, MSBuildLogsExtended.EntityFrameworkContext.Solution>(_ItemOfInput, _LinqItem);
                ...
                for (int i = 0; i < input.Count; i++)
                {
                    MSBuildLogsExtended.EntityContracts.ISolutionHelper.Copy
                        <
                            MSBuildLogsExtended.EntityFrameworkContext.Solution, MSBuildLogsExtended.DataSourceEntities.Solution
        ...
        {
            MSBuildLogsExtended.EntityFrameworkContext.Solution _Only = GetLinqObjectByIdentifier(id);
            if (_Only != null)
            {
        ...
        /// </summary>
        /// <param name="id">The id.</param>
        /// <returns>an instance of <see cref="MSBuildLogsExtended.EntityFrameworkContext.Solution"/> class, with same identifier, which is a IQueryable.</returns>
        private MSBuildLogsExtended.EntityFrameworkContext.Solution GetLinqObjectByIdentifier(MSBuildLogsExtended.EntityContracts.ISolutionIdentifier id)
        {
            Func<MSBuildLogsExtended.EntityFrameworkContext.Solution, bool> m_Predicate = (MSBuildLogsExtended.EntityFrameworkContext.Solution t) =>
            {
                return MSBuildLogsExtended.EntityContracts.ISolutionIdentifierHelper.Equals<MSBuildLogsExtended.EntityContracts.ISolutionIdentifier, MSBuildLogsExtended.EntityFrameworkContext.Solution>(id, t);
            };

            return this.LinqContext.Solutions.SingleOrDefault<MSBuildLogsExtended.EntityFrameworkContext.Solution>(m_Predicate);
        }
			...
			)
        {
			var _ResultFromDataSource = 
				(
					...
					select new MSBuildLogsExtended.DataSourceEntities.Solution.KeyInformation { Id = t.Id, Name = t.Name } into vD2
					select vD2
				);
			var _retval = _ResultFromDataSource;
