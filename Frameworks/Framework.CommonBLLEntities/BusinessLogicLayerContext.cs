...
namespace Framework.CommonBLLEntities
{
    ...
    /// </summary>
	//[Framework.BusinessLogicLayerContextSetting("MSBuildLogsExtended", typeof(BusinessLogicLayerContext), typeof(MSBuildLogsExtended.DALContracts.DataAccessLayerFactoryContract))]
	public partial class BusinessLogicLayerContext
    {
        ...
        public BusinessLogicLayerContext(
			...
			//, MSBuildLogsExtended.DALContracts.DataAccessLayerFactoryContract dataAccessLayerFactory
			)
        {
        ...
        ///// </value>
		//public MSBuildLogsExtended.DALContracts.DataAccessLayerFactoryContract DataAccessLayerFactory { get; set; }
    }
}